...
import com.sxh.demo.adapters.LinearPicsAdapter;
...
public class LieanrRecycleActivity extends AppCompatActivity {
    private RecyclerView mRecyclerView;
    private LinearPicsAdapter mPicsAdapter;
    ...
    private void initViews() {
        ...
        mPicsAdapter =new LinearPicsAdapter(this);
    ...
    private void initVars() {
        ...
        mPicsAdapter.setItemClickListeners(new LinearPicsAdapter.OnItemClickListeners() {
            @Override
            public void onClickListener(int position) {
                AllUtils.startImagePage(LieanrRecycleActivity.this,mStrings,mPicsAdapter.getAllView(), position);
